		...
		backpack: {
			...
			portOHive: {
				mesh: function (box, cylinder, sphere) {
					...
					cylinder(0, 0.2, -0.675, 0.43, 0.1, 15, 1.5, 1.4, 1, 90, 0, 0);
					cylinder(0, 0.35, -0.6, 0.25, 0.15, 10, 1.5, 1.4, 1, 90, 0, 0);
					cylinder(0, -0.2, -0.675, 0.43, 0.1, 15, 1.5, 1.4, 1, 90, 0, 0);
					cylinder(0, -0.35, -0.6, 0.25, 0.1, 15, 1.5, 1.4, 1, 90, 0, 0);
			...
			redPortOHive: {
				mesh: function (box, cylinder, sphere) {
					...
					cylinder(0, 0.2, -0.675, 0.43, 0.1, 15, 1.4, 0, 0, 90, 0, 0);
					cylinder(0, 0.35, -0.6, 0.25, 0.15, 10, 1.4, 0, 0, 90, 0, 0);
					cylinder(0, -0.2, -0.675, 0.43, 0.1, 15, 1.4, 0, 0, 90, 0, 0);
					cylinder(0, -0.35, -0.6, 0.25, 0.1, 15, 1.4, 0, 0, 90, 0, 0);
			...
			bluePortOHive: {
				mesh: function (box, cylinder, sphere) {
					...
					cylinder(0, 0.2, -0.675, 0.43, 0.1, 15, 0, 0, 1.4, 90, 0, 0);
					cylinder(0, 0.35, -0.6, 0.25, 0.15, 10, 0, 0, 1.4, 90, 0, 0);
					cylinder(0, -0.2, -0.675, 0.43, 0.1, 15, 0, 0, 1.4, 90, 0, 0);
					cylinder(0, -0.35, -0.6, 0.25, 0.1, 15, 0, 0, 1.4, 90, 0, 0);
			...
			porcelainOHive: {
				mesh: function (box, cylinder, sphere) {
					...
					cylinder(0, 0.2, -0.675, 0.43, 0.1, 15, 1.3, 1.3, 1.3, 90, 0, 0);
					cylinder(0, 0.35, -0.6, 0.25, 0.15, 10, 1.3, 1.3, 1.3, 90, 0, 0);
					cylinder(0, -0.2, -0.675, 0.43, 0.1, 15, 1.3, 1.3, 1.3, 90, 0, 0);
					cylinder(0, -0.35, -0.6, 0.25, 0.1, 15, 1.3, 1.3, 1.3, 90, 0, 0);
